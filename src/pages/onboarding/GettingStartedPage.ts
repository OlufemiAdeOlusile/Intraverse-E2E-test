...
import { VerificationPage } from '../signUpAndLogin/VerificationPage';
...
export class GettingStartedPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.newToIntraverseText = page.getByText(/new to intraverse\? try the 4 step guide to get started\./i);
        this.startYourGuideButton = page.getByRole('button', { name: /start your guide/i });
        this.bookAFlightText = page.getByText(/book a flight/i);
        this.activateMyBusiness = page.getByText(/activate my business/i);
        this.chooseASubscriptionPlan = page.getByText(/choose a subscription plan/i);
