...
test.describe('Onboarding a business without IATA and subscribe', (): void => {
  ...
  test.describe('Onboard a business without IATA', () => {
  ...
  test.describe('Subscribe to a yearly premium plan', async () => {
    ...
    test('Choose a yearly premium subscription plan', async (): Promise<void> => {
